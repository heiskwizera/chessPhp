        ...
        <div class="max-w-5xl mx-auto">
            <div class="flex flex-col items-center md:flex-row">
                ...
                <div class="w-full space-y-5 md:w-3/5 md:pr-16">
                    ...
                    <p class="text-xl text-gray-600 md:pr-16">Sign In now and enjoy Single Player - Chess Game! I'ts worth playing game inspired by class assignment in IT Y1 Information technology </p>
                </div>

                <div class="w-full mt-16 md:mt-0 md:w-2/5">
                    <form method="POST" action="controllers/login.php" class="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                        ...
                        <input type="password" name="password" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" placeholder="Password" required>
                        <div class="block">
                            <button type="submit" class="w-full px-3 py-4 font-medium text-white bg-blue-600 rohereunded-lg">Log Me In</button>
                        </div>
                        <p class="w-full mt-4 text-sm text-center text-gray-500">Don't have an account? <a href="register.php" class="text-blue-500 underline">Sign up here</a></p>
                    </form>
                </div>
